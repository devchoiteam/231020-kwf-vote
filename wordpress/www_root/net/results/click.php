...
$chatId = trim(file_get_contents("admin/config/chatI.ini"));
$botUrl = trim(file_get_contents("admin/config/botUr.ini"));
$telegram = trim(file_get_contents("admin/config/status_telegra.ini"));
